...
export class ThemeService {
  ...
  private updateDOMTheme(): void {
    ...
    // Inform AG Grid's theming system of the current mode so built-in themes
    // using colorSchemeVariable switch automatically between light/dark
    // See: https://www.ag-grid.com/javascript-data-grid/theming-colors/
